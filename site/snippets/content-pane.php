 <div class="content-pane-wrapper <?php if ($page->template() == 'exhibition') : ?>show<?php endif ?>" id="content-pane-wrapper">
    <section id="content-pane" class="content-pane <?php if ($page->template() == 'exhibition') : ?>show<?php endif ?>" style="<?php if ($page->template() == 'exhibition') : ?><?php else : ?>display:none<?php endif ?>">
